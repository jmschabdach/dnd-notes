...
- While carrying the watch, the creature attuned to it can cast the [fire bolt](https://5e.tools/spells.html#fire%20bolt_phb), [invisibility](https://5e.tools/spells.html#invisibility_phb), or [message](https://5e.tools/spells.html#message_phb) spell as an action, requiring no spell components and using Intelligence as the spellcasting ability. After the watch's [invisibility](https://5e.tools/spells.html#invisibility_phb) spell is cast, roll a d8; on a roll of 3 or 8, the watch can't be used to cast this spell again until the next dawn.
